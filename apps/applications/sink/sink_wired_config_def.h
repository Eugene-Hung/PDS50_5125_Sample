...
#define SINK_WIRED_WRITEABLE_CONFIG_BLK_ID 1149
...
#define SINK_WIRED_READONLY_CONFIG_BLK_ID 1159
...
#define SPDIF_SETTINGS_CONFIG_BLK_ID 1169

typedef struct {
    spdif_configuration_t SpdifConfig;
} spdif_settings_config_def_t;

#define I2S_DATA_CONFIG_BLK_ID 1174
